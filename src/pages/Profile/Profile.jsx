...
const Profile = () => {
    ...
    <div className="hero min-h-screen rounded-lg">
      <div className="hero-content grid lg:grid-cols-2 sm:grid-cols-1 ">
        <div className="mx-auto items-center w-full mr-5">
          <div className=" text-slate-50 bg-blue-950 rounded-md  font-mono min-h-screen p-8">
            <div className="flex justify-between m-5">
              <Link to='/' className="btn btn-ghost normal-case text-xl">User Profile</Link>
            ...
            <div className="w-full mx-auto ">
              <div className="text-center">
                <img
                  src="https://cdn.dribbble.com/userupload/10116689/file/original-e382fbc040f0e06a0c44d2a500d31821.jpg?resize=1024x768"
                  alt="User Avatar"
        ...
        <CgMail className="w-6 h-6"/>
          ...
          <p className="0 font-serif">john@example.com</p>
        </div>
        <div className="mt-6 border-4 border-indigo-500/7 rounded-full p-5 flex gap-3 items-center">
        ...
        <FaRegAddressCard className="w-6 h-6"/>
          ...
          <p className=" font-serif text-slate-50">123 Main Street, City, Country</p>
        </div>
            </div>
          </div>
        </div>
  ...
  <li><a>Item 1</a></li>
  <div className="divider divider-horizontal text-red-500 bg-red-600">|</div>
  <li><a>Item 2</a></li>
  <div className="divider divider-horizontal text-red-500 bg-red-600">|</div>
  <li><a>Item 3</a></li>
</ul>
        ...
        <div className="m-6">
          ...
          <p className="text-gray-700">
            In my free time, I love hiking, reading, and playing the guitar. I'm
            also a coffee enthusiast and enjoy exploring new coffee shops.
          </p>
        </div>
      ...
      <EditUserModel
      isOpen={isOpen} setIsOpen={setIsOpen} closeModal={closeModal}
      />
    </div>
  );
};
